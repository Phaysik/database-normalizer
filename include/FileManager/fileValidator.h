    ...
    */
    ...
    public:
        ...
        */
        ...
        /*! \brief Validates calls to \ref #normalizer::file::FileManager::grabFileContents "FileManager::grabFileContents"
            ...
            \param[in] isPathADirectory If \ref #normalizer::file::FileManager::FileManager "FileManager" was created with directory access in mind
